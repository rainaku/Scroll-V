...
namespace SmoothScroll.Core
{
    ...
    public class SmoothScrollManager : IDisposable
    {
        ...
        private readonly SmoothScrollEngine _scrollEngine;
        ...
        public SmoothScrollManager()
        {
            _settings = AppSettings.Load();
            _mouseHook = new MouseHook();
            _scrollEngine = new SmoothScrollEngine();
        ...
        public void Start()
        {
            ...
            StatusChanged?.Invoke(this, "SmoothScroll is running");
        }
        ...
        public void Stop()
        {
            ...
            _scrollEngine.Reset();
            StatusChanged?.Invoke(this, "SmoothScroll is paused");
        }
        ...
        private void OnMouseScroll(object? sender, MouseScrollEventArgs e)
        {
            ...
            if (e.ProcessName.Equals("SmoothScroll", StringComparison.OrdinalIgnoreCase))
            {
